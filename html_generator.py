...
TEST_TEXT = """TITLE: Web Crawler
DESCRIPTION: Web Crawler is a program that collects
content by following links from other webpages.
TITLE: Computer
DESCRIPTION: A Computer is a machine that can
be programmed to do whatever you want it to do.
TITLE: Computer Program
DESCRIPTION: A Computer Program is a precise sequence
of steps that tells the computer what to do."""
